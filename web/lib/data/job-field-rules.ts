...
export const JOB_FIELD_RULES: Record<JobFieldKey, JobFieldRule> = {
  ...
  pack_pattern_1: { key: "pack_pattern_1", label: "Pack Size (1)", perm: "plan", lockFrom: 3 },
  pack_pattern_2: { key: "pack_pattern_2", label: "Pack Size (2)", perm: "plan", lockFrom: 3 },
  pack_pattern_3: { key: "pack_pattern_3", label: "Pack Size (3)", perm: "plan", lockFrom: 3 },
