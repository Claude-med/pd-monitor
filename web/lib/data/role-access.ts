...
export const ROLE_ACCESS: Record<AppRole, RoleAccess> = {
  ...
  planner_lead: {
    ...
    manage: [
      ...
      "สร้าง/ดูแล/ลบบัญชีพนักงานในฝ่ายวางแผน",
      "ลบงานได้ทุกขั้น (ต้องกรอกรหัสผ่านยืนยัน)",
    ],
    view: ["ความคืบหน้าทุกงานบนบอร์ด"],
  },
  production: {
  ...
  production_lead: {
    ...
    manage: [
      ...
      "ส่งตรวจ QC (กำลังผลิต → QC) — เฉพาะหัวหน้า",
  ...
  qc_lead: {
    ...
    manage: [
      ...
      "QC ผ่าน → ส่ง QA · QC ตีกลับ (ต้องลงนาม) — เฉพาะหัวหน้า",
  ...
  qa_lead: {
    ...
    manage: [
      ...
      "อนุมัติผล ผ่าน/ไม่ผ่าน จุดเก็บตัวอย่าง (ตรวจ Finished product) · ลบรายการ",
      "อนุมัติ/ปฏิเสธ คำขอแก้ไขจุดเก็บตัวอย่าง ในแท็บ คำขอแก้ไข (Amendment)",
      "สร้าง/ดูแล/ลบบัญชีพนักงานในฝ่าย QA",
      "ลบงานได้ทุกขั้น (ต้องกรอกรหัสผ่านยืนยัน)",
    ],
  ...
  qa: {
    ...
    manage: [
      "บันทึก/แก้ไข จุดเก็บตัวอย่าง (ตรวจ Finished product) — รอหัวหน้า QA อนุมัติผล",
      "รายการที่อนุมัติแล้ว → ยื่นคำขอแก้ไข (ค่าเดิมคงอยู่จนหัวหน้า QA อนุมัติ)",
      "QA ปล่อยผ่าน → FG · QA ตีกลับ (ต้องลงนาม)",
      "ตรวจสอบ Incident Case — ระบุประเภท DEV/OOS/NC + เลขที่ + แผนกที่รับผิดชอบ แล้วปิดเคส",
      // Part Notification (0084): ถอด "อนุมัติคำขอแก้ไขข้อมูล QC" ออก —
      //   คำขอแก้ผลตรวจ in-process เป็นเรื่องภายในของฝ่าย QC (หัวหน้า QC + ผู้บริหาร)
    ],
    view: ["ประวัติ / Audit", "ไล่ย้อนล็อต (Trace)"],
  },
  warehouse: {
    code: "WH",
  ...
  warehouse_lead: {
    ...
    manage: [
      ...
      "สร้าง/ดูแล/ลบบัญชีพนักงานในฝ่ายคลัง",
      "ลบงานได้ทุกขั้น (ต้องกรอกรหัสผ่านยืนยัน)",
    ],
    view: ["คลัง / FG", "เบิกวัตถุดิบ / บรรจุภัณฑ์", "ไล่ย้อนล็อต (Trace)"],
  },
  ...
  engineering_lead: {
    ...
    manage: [
      ...
      "สร้าง/ดูแล/ลบบัญชีพนักงานในฝ่ายวิศวกรรม",
      "ลบงานได้ทุกขั้น (ต้องกรอกรหัสผ่านยืนยัน)",
    ],
    view: ["รายงานการใช้เครื่อง"],
  },
  ...
  manager: {
    ...
    manage: [
      ...
      "ลงนามขั้น QC/QA ไม่ได้ — ขั้น QC ต้องเป็นหัวหน้า QC · ขั้น QA ต้องเป็น QA (หรือหัวหน้า QA)",
      "ส่งตรวจ QC แทนหัวหน้าฝ่ายผลิตไม่ได้ (Part G)",
