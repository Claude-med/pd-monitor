...
export const COMMON_VIEW =
  "แดชบอร์ด · บอร์ดงาน · รายงานประจำวัน · เครื่องจักร · วัตถุดิบ/คลัง · สูตรการผลิต/BOM · แจ้งเตือน";
...
export const ROLE_ACCESS: Record<AppRole, RoleAccess> = {
  ...
  production: {
    ...
    manage: [
      ...
      "ขอเบิกวัตถุดิบตาม BOM · ส่งตรวจ QC",
  ...
  warehouse: {
    code: "WH",
    duty: "คลังวัตถุดิบ + รับสินค้าสำเร็จรูปเข้าคลัง",
    manage: [
      "ทะเบียนวัตถุดิบ + ล็อตวัตถุดิบ (RM/PM)",
  ...
  manager: {
    ...
    manage: [
      "ทำได้ทุกขั้นของงานผลิต (สร้างงาน/ยืนยันแผน/เครื่องจักร/วัตถุดิบ)",
      "จัดการผู้ใช้ + กำหนดสิทธิ์ · รีเซ็ตรหัสผ่าน · ระงับบัญชี",
      "สูตรการผลิต / BOM / สถานี / รูปแบบบรรจุ",
