...
**⚠️ pd-monitor.vercel.app ค้าง** — Vercel บล็อก auto-deploy (Hobby + private repo + author ไม่ตรงเจ้าของ) → ใช้ลิงก์ใหม่แทน
**ถัดไป:** โชว์ CEO demo (ลิงก์ใหม่) → เก็บ feedback → เริ่มเฟส 1 (D1 scaffold Next.js)
