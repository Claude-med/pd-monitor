...
**ถัดไป:** เริ่ม **D2** — schema + seed · เปิด RLS ทุกตาราง · `audit_log` trigger · คอลัมน์ ALCOA · batch mfg/expiry
  (อ่าน `docs/recommendations.md` A/B/D + fetch Notion เช็ก requirement ใหม่ก่อน)
