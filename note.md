...
## 📅 บันทึกวันที่ 22 มิถุนายน 2569 — เฟส 4 / D4 (ล่าสุด)
...
**เฟส 4 / D4 = เขียนโค้ดเสร็จ + build ผ่าน ✅ (22 มิ.ย. 69)** — บอร์ดงาน + รายละเอียด job + กันข้ามสถานะ
  · kanban responsive + search/filter + KPI · stepper + ปุ่มเปลี่ยนสถานะตาม role (ตีกลับมีเหตุผล)
  · push GitHub แล้ว · ⏳ **รอผู้ใช้ paste `0006_job_transitions.sql`** แล้วปุ่มเปลี่ยนสถานะถึงทำงาน
**ถัดไป:** หลัง paste 0006 → **D5** — ฟอร์มบันทึกผลิตรายวัน + validation ฝั่ง server + ผูก batch/lot
  (อ่าน `docs/recommendations.md` C2 + fetch Notion เช็ก requirement ใหม่ก่อน)
