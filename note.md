...
## 📅 บันทึกวันที่ 22 มิถุนายน 2569 — เฟส 8 / D8 ส่วน 1: Realtime (ล่าสุด)
...
**เฟส 8 / D8 = กำลังทำ (แบ่งก้อน) — ส่วน 1 Realtime เสร็จ ✅ (22 มิ.ย. 69)**
  ...
  · ⏳ **รอ paste `0009_realtime.sql`** (เปิด publication 3 ตาราง) แล้วถึงจะ broadcast · ⏳ ยังไม่ทดสอบ UI
  · **ส่วน 2 (ถัดไป):** เทส RLS impersonation (B4) · perf · ขัดเกลามือถือ · groundwork offline (C1)
